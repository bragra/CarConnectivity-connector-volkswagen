...
from carconnectivity_connectors.volkswagen.auth.login._idkit import IdKitInfo, IdKitPageObject, IdKitStage
...
class LoginVerifier:
    ...
    @staticmethod
    def _extract_form(html: str, selector: str) -> tuple[str, dict] | None:
    ...
    def _warn(self, message: str) -> None:
        LOG.warning("LoginVerifier: %s", message)
